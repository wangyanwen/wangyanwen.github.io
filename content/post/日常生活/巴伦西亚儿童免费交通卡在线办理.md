...
1. Móbilis30 个性化卡申请
    ...
    Metrovalencia 在其 “Móbilis30” 页面说明：要申请个性化 Móbilis30 卡，需要通过 ATMV 的 SIGAPUNT 系统（sigapunt.gva.es）。
...
3. 申请入口 /说明
    ...
    - 在 Metrovalencia “Tarjeta personalizada”页面写道：“Las solicitudes de las tarjetas personalizadas de la ATMV … se realizan a través de la web de la ATMV https://atmv.gva.es/va/suma.”（个性化卡申请通过 ATMV 的 SUMA 系统网页办理）
...
如果你愿意的话，我可以帮你查一个具体的 “SIGAPUNT / ATMV SUMA 入口链接”，然后帮你试着模拟流程看看哪一步卡住了。要吗？
...
- 即便你在 SIGAPUNT 平台成功申请，卡片很可能不会现场领取，而是由系统邮寄到你家地址。 Metrovalencia / Conselleria 的说明就说“tarjeta … se enviará por correo ordinario al domicilio indicado en la solicitud” 
