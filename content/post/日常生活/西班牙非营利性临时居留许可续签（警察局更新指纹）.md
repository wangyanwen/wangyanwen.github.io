...
2. **790-012 缴费单**（已付过钱的那份）。
    
3. **护照原件** + 护照首页及所有签证页复印件。
    
4. **预约确认单**（Cita Previa 的打印件或手机截图）。
    
5. **白底证件照**（1 张，西班牙尺寸 32x26mm，即 Carnet 尺寸）。
    
6. **居留批复单**（Resolución）或签证页（如果是首次办理）。
    
7. **住家证明**（Padrón）：如果你在 EX-17 上填的地址和之前递交材料时的地址变了，必须带上近 3 个月内开具的住家证明。
    

**您需要我为您查一下瓦伦西亚地区（Valencia）最近的警察局地址或如何查询预约状态吗？**