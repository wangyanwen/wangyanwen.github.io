...
**今天发现预约系统已启用电子证书登录预约，脚本不再能使用。**

**  **IMPORTANTE:**  Nº de NIE utilizado en la reserva de la cita, debe coindicir plenamente con el asignado al ciudadano, en caso contrario, la cita no será atendida . **

重要提示：预约时使用的NIE号码必须与公民登记的号码完全一致，否则将无法办理预约事宜。
